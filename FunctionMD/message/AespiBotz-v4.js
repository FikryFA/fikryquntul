...
function randomNomor(min, max = null) {
   ...
   let LETT = 1;
   let kata = `Sekali Lagi Mohon Maaf Jika Ada Beberapa Fitur Yang Error🙏`
   let head = `╭───╼[ THANKS TO ]╾──➲`
   let head2 = "│ Ariel SP"
...
break
  ...
  case 'lagu': case 'musik': case 'yts': case 'ytsearch': 
